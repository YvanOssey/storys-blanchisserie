...
export default function PublicOrder() {
  ...
  return (
    <div className="min-h-screen bg-[#f7f3ec] text-[#00514d]">
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-5 py-5 sm:px-8 lg:px-10"><Link href="/" className="flex items-center gap-3"><span className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#00514d] text-[#e8c875] shadow-md"><span className="font-display text-xl italic">S</span></span><span><span className="block font-display text-xl leading-none">Story’s</span><span className="mt-1 block text-[9px] font-bold uppercase tracking-[0.2em] text-[#99772a]">Lavage & soins à domicile</span></span></Link></nav>
...
function Confirmation({ orderId, orderNumber, onRestart }: { orderId?: number; orderNumber: string; onRestart: () => void }) {
  return <div className="min-h-screen bg-[#f7f3ec] text-[#00514d]"><nav className="mx-auto flex max-w-7xl items-center justify-between px-5 py-5 sm:px-8"><Link href="/" className="flex items-center gap-3"><span className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#00514d] text-[#e8c875]"><span className="font-display text-xl italic">S</span></span><span className="font-display text-xl">Story’s</span></Link></nav><main className="mx-auto flex max-w-2xl items-center justify-center px-5 py-14 sm:px-8"><div className="w-full rounded-[2rem] bg-white p-8 text-center shadow-[0_24px_80px_rgba(16,32,51,0.10)] sm:p-14"><div className="mx-auto flex h-20 w-20 items-center justify-center rounded-3xl bg-[#e8f6ef] text-[#367957]"><CheckCircle2 className="h-9 w-9" /></div><p className="eyebrow mt-7 text-[#99772a]">Demande bien reçue</p><h1 className="mt-3 font-display text-4xl text-[#00514d]">Merci, nous prenons le relais.</h1><p className="mx-auto mt-4 max-w-md text-sm leading-7 text-[#647180]">Votre demande <strong className="text-[#00514d]">{orderNumber}</strong> est bien arrivée à l’atelier. Nous vous recontactons pour confirmer le tarif et le créneau.</p><div className="mt-8 grid gap-3 rounded-2xl bg-[#faf9f6] p-4 text-left sm:grid-cols-2"><div className="flex items-center gap-3"><Phone className="h-4 w-4 text-[#99772a]" /><span className="text-xs text-[#647180]">Nous vous appelons pour confirmer</span></div><div className="flex items-center gap-3"><Clock3 className="h-4 w-4 text-[#99772a]" /><span className="text-xs text-[#647180]">Délai indicatif de 72 heures</span></div></div><div className="mt-8 grid gap-3 sm:grid-cols-2"><Button asChild className="rounded-xl bg-[#00514d] text-white hover:bg-[#123c3a]"><Link href={orderId ? `/mon-espace/commandes/${orderId}` : "/mon-espace"}>Voir le suivi de cette commande <ArrowRight className="ml-2 h-4 w-4" /></Link></Button><Button onClick={onRestart} variant="outline" className="rounded-xl border-[#00514d]/20 text-[#00514d]">Faire une autre demande</Button></div></div></main></div>;
}
