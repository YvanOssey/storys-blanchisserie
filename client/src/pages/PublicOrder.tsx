...
export default function PublicOrder() {
  ...
  return (
    <div className="min-h-screen bg-[#f7f3ec] text-[#00514d]">
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-5 py-5 sm:px-8 lg:px-10"><Link href="/" className="flex items-center gap-3"><span className="flex h-10 w-10 items-center justify-center overflow-hidden rounded-xl bg-[#00514d]"><img src="/favicon.png" alt="Story’s" className="h-full w-full object-contain" /></span><span><span className="block font-display text-xl leading-none">Story’s</span><span className="mt-1 block text-[9px] font-bold uppercase tracking-[0.2em] text-[#99772a]">Lavage & soins à domicile</span></span></Link></nav>
...
function Confirmation({ orderId, orderNumber, onRestart }: { orderId?: number; orderNumber: string; onRestart: () => void }) {
  return <div className="min-h-screen bg-[#f7f3ec] text-[#00514d]"><nav className="mx-auto flex max-w-7xl items-center justify-between px-5 py-5 sm:px-8"><Link href="/" className="flex items-center gap-3"><span className="flex h-10 w-10 items-center justify-center overflow-hidden rounded-xl bg-[#00514d]"><img src="/favicon.png" alt="Story’s" className="h-full w-full object-contain" /></span>
